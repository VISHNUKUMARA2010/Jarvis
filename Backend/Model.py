...
from rich import print  # Import the Rich library for enhanced terminal output.
...
funcs = [
    ...
    "youtube search", "reminder", "skip ads"
]
...
-> Respond with 'system (task name)' if a query is asking to mute, unmute, volume up, volume down, shutdown, restart, lock, sleep, hibernate, log off etc. For example if the query is 'shutdown my pc' respond with 'system shutdown', if the query is 'restart my computer' respond with 'system restart', if the query is 'lock my pc' respond with 'system lock', if the query is 'put my pc to sleep' respond with 'system sleep'. But if the query is asking to do multiple tasks, respond with 'system 1st task, system 2nd task', etc.
-> Respond with 'content (topic)' if a query is asking to write any type of content like letters (sick leave letter, application letter, resignation letter), applications, codes, emails, essays, poems, stories or anything else that should be written in notepad. For example if the query is 'write a sick leave letter' respond with 'content sick leave letter', if the query is 'write a job application' respond with 'content job application', if the query is 'write a python code for calculator' respond with 'content python calculator code', if the query is 'write an email to my boss' respond with 'content email to boss'. But if the query is asking to write multiple types of content, respond with 'content 1st topic, content 2nd topic' and so on.
-> Respond with 'google search (topic)' if a query is asking to search a specific topic on google but if the query is asking to search multiple topics on google, respond with 'google search 1st topic, google search 2nd topic' and so on.
-> Respond with 'youtube search (topic)' if a query is asking to search a specific topic on youtube but if the query is asking to search multiple topics on youtube, respond with 'youtube search 1st topic, youtube search 2nd topic' and so on.
-> Respond with 'skip ads' if a query is asking to skip youtube ads like 'skip the ad', 'skip ads', 'skip this ad', 'skip advertisement', etc.
...
ChatHistory = [
    ...
    {"role": "Chatbot", "message": "general what is date, reminder 11:00pm 5th aug dancing performance"},
    {"role": "user", "message": "chat with me."},
    {"role": "Chatbot", "message": "general chat with me."},
    {"role": "user", "message": "shutdown my pc"},
    {"role": "Chatbot", "message": "system shutdown"},
    {"role": "user", "message": "restart my computer"},
    {"role": "Chatbot", "message": "system restart"},
    {"role": "user", "message": "lock my pc"},
    {"role": "Chatbot", "message": "system lock"},
    {"role": "user", "message": "skip the ads"},
    {"role": "Chatbot", "message": "skip ads"},
    {"role": "user", "message": "skip this ad"},
    {"role": "Chatbot", "message": "skip ads"},
    {"role": "user", "message": "write a sick leave letter"},
    {"role": "Chatbot", "message": "content sick leave letter"},
    {"role": "user", "message": "can you write a job application letter for me"},
    {"role": "Chatbot", "message": "content job application letter"},
    {"role": "user", "message": "write an email to my manager"},
    {"role": "Chatbot", "message": "content email to manager"}
]
